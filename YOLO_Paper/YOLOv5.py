# train_yolov5_coco128_team.py
# -*- coding: utf-8 -*-
"""
YOLOv5 (Ultralytics) 학습/검증/예측 저장 + GT/Pred 좌우 합성 저장
...
RUNS_DIR = TP / "_runs_yolov5"
OUT_DIR = TP / "_out_yolov5"
PRED_IMG_DIR = OUT_DIR / "pred_images_v5"   # Ultralytics가 그려준 예측 이미지
...
def main():
    ...
    pred_results = model.predict(
        ...
        project=str(OUT_DIR), name="pred_images_v5", exist_ok=True, verbose=False
    )
    ...
    csv_path = CSV_DIR / "predictions_v5.csv"; df.to_csv(csv_path, index=False, encoding="utf-8")
